...
DataONE environment | *dataone* R package abbreviation | CN URL
------------------- | -------------------------------- | --------------------------
production          | PROD                             | https://cn.dataone.org/cn
stage               | STAGING                          | https://cn-stage.test.dataone.org/cn
stage 2             | STAGING2                         | https://cn-stage-2.test.dataone.org/cn
sandbox             | SANDBOX                          | https://cn-sandbox.test.dataone.org/cn
sandbox2            | SANDBOX2                         | https://cn-sandbox-2.test.dataone.org/cn
dev                 | DEV                              | https://cn-dev.test.dataone.org/cn
dev2                | DEV2                             | https://cn-dev.test.dataone.org/cn
...
Note: this same information can be obtained by navigating a web browser to https://cn.dataone.org/cn/v2/node.
