...
Access to DataONE data is provided by the [DataONE REST API](https://search.dataone.org/api/). DataONE maintains a set of 
user oriented client tools that use this service interface to search, download and upload data to DataONE Member repositories. These include 
web clients (like [MetacatUI](https://nceas.github.io/metacatui/)), and clients in python and R. The `dataone` R package implements the DataONE API for R.
...
- [DataONE Coordinating Node API](https://purl.dataone.org/architecture/apis/CN_APIs.html)
- [DataONE Member Node API](https://purl.dataone.org/architecture/apis/MN_APIs.html)
