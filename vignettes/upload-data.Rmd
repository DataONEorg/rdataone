...
the relationship that links a metadata object and a science object is [CITO](https://purl.org/spar/cito) *documents*. 
...
Since `metadataObj` is included as the third argument here, the [CITO](https://purl.org/spar/cito) *documents*
...
Note that the relationship type, using the `insertRelationship()` `predicate` argument does not have to be specified in this case, as the [CITO](https://purl.org/spar/cito) *documents* relationship is the default value for `insertRelationship`.
