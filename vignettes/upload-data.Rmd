...
A single dataset or metadata file can be uploaded to a DataONE MN using the *createObject* method.
...
another object, etc. The system metadata information that will be uploaded to DataONE is collected and stored
in an R object type *datapack::SystemMetadata*, as shown below:
