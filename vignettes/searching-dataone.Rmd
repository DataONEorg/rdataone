...
Data can also be discovered programatically from R using the *dataone* R client method `query`. Both the web page and the R method
access the same
...
The complete list of possible searchable values stored for a dataset can be viewed at [DataONE Solr Engine Description](https://cn.dataone.org/cn/v1/query/solr). However,
