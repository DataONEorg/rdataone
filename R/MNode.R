...
#' metadata objects.  
#' @details   
#' Methods that perform write operations (such as createObject and updateObject) on the Member Node generally require
