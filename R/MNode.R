...
#' @section Methods:
#' \describe{
#'  \item{[MNode()]}{: Create a MNode object representing a DataONE Member Node repository.}
#'  \item{[createObject()]}{: Create an object on a Member Node.}
#'  \item{[getObject()]}{: Get the bytes associated with an object on the Member Node}
#'  \item{[getCapabilities()]}{: Get the node capabilities description, and store the information in the MNode.}
#'  \item{[generateIdentifier()]}{: Get a unique identifier that is generated by the Member Node repository and guaranteed to be unique.}
#'  \item{[getPackage()]}{: Download a data package from a member node.}
#'  \item{[updateObject()]}{: Update an object to a Member Node, by creating a new object that replaces an original.}
#'  \item{[updateSystemMetadata()]}{: Update the system metadata associated with an object.}
#' }
...
#' @details If the `'x'` is a string, it is treated as a URI and an attempt to find an associated
#' Member Node at that base URL is attempted.  If `'x'` is a Node reference, then it is cast to a MNode
...
#' @seealso [`MNode()`][MNode-class] class description.
#' @export
#' @examples \dontrun{
...
#' @seealso <https://purl.dataone.org/architecture/apis/MN_APIs.html#MN_core.getCapabilities>
#' @import XML
#' @import httr
#' @export
#' @examples \dontrun{
...
#' provided in the `'mnode'` parameter.  
...
#' @param ... (Not yet used.)
#' @return a `character` containing the identifier that was created.
#' @seealso <https://purl.dataone.org/architecture/apis/MN_APIs.html#MNStorage.create>
#' @import datapack
#' @export
#' @examples \dontrun{
...
#' @param dataobj a `raw` object to use for the upload, instead of the contents of the `file` argument.
...
#' @param ... (Not yet used.)
#' @return A `character` containing the identifier if successful.
#' @seealso <https://purl.dataone.org/architecture/apis/MN_APIs.html#MNStorage.update>
#' @import datapack
#' @export
#' @note Please see the vignette *v05-upload-data* for an example: `vignette("v05-upload-data")`
...
#' @seealso <https://purl.dataone.org/architecture/apis/MN_APIs.html#MNStorage.updateSystemMetadata>
#' @import datapack
#' @export
#' @note Please see the vignette *v05-upload-data* for an example: `vignette("v05-upload-data")`
...
#' @seealso <https://purl.dataone.org/architecture/apis/MN_APIs.html#MNStorage.generateIdentifier>
#' @export
#' @examples
#' \dontrun{
#' library(dataone)
