...
Note: In this R package documentation, *dataone* refers to the R package and *DataONE* refers to the Federation of Member Nodes and the computer infrastructure comprising the data repositories on there.
